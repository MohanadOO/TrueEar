...
function Footer() {
  return (
    <footer className='absolute bottom-0 py-5 px-5 md:px-10 w-full bg-gradient-to-r from-primary/70 to-secondary/60 shadow-md flex items-center justify-around  font-semibold text-sm'>
